% Rotina que realiza o plot das formas modais da estrutura  


function desenhaformasmodais(coords,coordsz,numNos,restrs,conect,matFmodal1)
...
title('1º Forma Modal ');

for i = 1:numNos
  coordsdef(i,1) = coords3d(i,1);
  coordsdef(i,2) = coords3d(i,2);
  coordsdef(i,3) = coords3d(i,3) + matFmodal1(i,1)*escaladesloc;
end 
