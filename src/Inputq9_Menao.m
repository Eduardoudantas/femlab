...
%dados de entrada 
 ...
 A = 0.38;   % Dimensão do lado A da placa em metros 
 B = 0.024;   % Dimensão do lado B da placa em metros 
 NumElementosx =30 ;
 NumElementosy =20; 
...
t= 0.00121;  % Espessura da chapa em metros
...
[matD,matPr,matS,matE,matFreq,matFmodal1] = AnalisePrincipalFEM (numGDLno,numNos,numElems,coords,restrs,cargasNos,conect,tipoElem,dadosElem );
